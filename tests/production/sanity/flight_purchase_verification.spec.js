import {blazedemo_menuSelectDeparture} from '../../../environments/production/sanity/pageObjects/menu_departure_destination_city/menu_departure_destination_city'
import {blazedemo_menuSelectDestination} from '../../../environments/production/sanity/pageObjects/menu_departure_destination_city/menu_departure_destination_city'
...
test.beforeEach(async({page}) => {
    ...
    logger.info('tests/production/sanity/flight_purchasse_verification.spec.js: Start test execution initialization...')
...
test.afterEach(async({page}, testInfo) => {
    ...
    if (testInfo.status === 'failed') {
        logger.error(`tests/production/sanity/flight_purchasse_verification.spec.js: Test failed at step: "${testInfo.title}"`)
    } else {
        logger.info(`tests/production/sanity/flight_purchasse_verification.spec.js: Test complete with status: ${testInfo.status.toUpperCase()} at step: ${testInfo.title}`)
    }
